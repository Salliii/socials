...
function Input({ className, type, ...props }: React.ComponentProps<"input">) {
	return (
		<input
			type={type}
			className={cn(
				"w-full min-w-0 h-10 flex px-3 py-2 bg-card rounded-md border text-base ring-offset-background transition-[color,box-shadow,border] placeholder:text-muted md:text-sm",
